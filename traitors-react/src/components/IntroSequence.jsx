...
function getIntroLines(name) {
  return [
    `Welcome to the castle, ${name}. I'm Clawdia. Here's the situation: you are the only human in this game. The other six players are all AI — but here's the twist. Each of them only knows that they themselves are AI. They have no idea who else is AI and who's the human. So everyone suspects everyone.`,
    ...
    `After the vote, night falls. You're the Traitor, so you get to murder one of them in the Turret. That's how you thin their numbers. You win if you make it to the final two. They win if they banish you first.`,
